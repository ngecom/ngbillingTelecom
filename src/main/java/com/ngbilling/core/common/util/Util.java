...
public class Util {
     ...
     * @return
     */
    static public int getDay(String str) throws Exception {
        // from the last '-' to the end
        try {
            return Integer.valueOf(str.substring(str.lastIndexOf('-') + 1));
        } catch (NumberFormatException e) {
            throw new Exception("Cant get the day from " + str);
        }
    }

    static public int getMonth(String str) throws Exception {
        // from the first '-' to the second '-'
        try {
            return Integer.valueOf(str.substring(str.indexOf('-') + 1, str.lastIndexOf('-')));
        } catch (NumberFormatException e) {
            throw new Exception("Cant get the month from " + str);
        }

    }

    static public int getYear(String str) throws Exception {
        // from the begining to the first '-'
        try {
            return Integer.valueOf(str.substring(0, str.indexOf('-')));
        } catch (NumberFormatException e) {
            throw new Exception("Cant get the year from " + str);
        }
    }
     ...
     */
    public static boolean luhnCheck(String cardNumber) throws Exception {

...
package com.ngbilling.core.server.util;
...
public final class ServerConstants extends CommonConstants {
    ...
    public static final Integer ORDER_PERIOD_ONCE = 1;
    
    public static final Integer ORDER_PERIOD_ALL_ORDERS = 5;

    // period unit types
    public static final Integer PERIOD_UNIT_MONTH = 1;
    public static final Integer PERIOD_UNIT_WEEK = 2;
    public static final Integer PERIOD_UNIT_DAY = 3;
    public static final Integer PERIOD_UNIT_YEAR= 4;
    public static final Integer PERIOD_UNIT_SEMI_MONTHLY= 5;
    
    // order billing types
    public static final Integer ORDER_BILLING_PRE_PAID = 1;
    public static final Integer ORDER_BILLING_POST_PAID = 2;
    
    // pluggable tasks categories
    public static final Integer PLUGGABLE_TASK_PROCESSING_ORDERS = 1;
    public static final Integer PLUGGABLE_TASK_ORDER_FILTER = 2;
    public static final Integer PLUGGABLE_TASK_INVOICE_FILTER = 3;
    public static final Integer PLUGGABLE_TASK_INVOICE_COMPOSITION = 4;
    public static final Integer PLUGGABLE_TASK_ORDER_PERIODS = 5;
    public static final Integer PLUGGABLE_TASK_PAYMENT = 6;
    public static final Integer PLUGGABLE_TASK_NOTIFICATION = 7;
    public static final Integer PLUGGABLE_TASK_PAYMENT_INFO = 8;
    public static final Integer PLUGGABLE_TASK_PENALTY = 9;
    public static final Integer PLUGGABLE_TASK_PROCESSOR_ALARM = 10;
    public static final Integer PLUGGABLE_TASK_SUBSCRIPTION_STATUS = 11;
    public static final Integer PLUGGABLE_TASK_ASYNC_PAYMENT_PARAMS = 12;
    public static final Integer PLUGGABLE_TASK_ITEM_MANAGER = 13;
    public static final Integer PLUGGABLE_TASK_ITEM_PRICING = 14;
    ...
    public static final Integer PLUGGABLE_TASK_INTERNAL_EVENT = 17;
    public static final Integer PLUGGABLE_TASK_VALIDATE_PURCHASE = 19;
    public static final Integer PLUGGABLE_TASK_BILL_PROCESS_FILTER = 20;
    public static final Integer PLUGGABLE_TASK_MEDIATION_ERROR_HANDLER = Integer.valueOf(21);
    public static final Integer PLUGGABLE_TASK_SCHEDULED = 22;
    public static final Integer PLUGGABLE_TASK_RULES_GENERATOR = 23;
    public static final Integer PLUGGABLE_TASK_AGEING = 24;
    public static final Integer PLUGGABLE_TASK_PARTNER_COMMISSION = 25;
    public static final Integer PLUGGABLE_TASK_FILE_EXCHANGE = 26;

    // pluggable task types (belongs to a category)
    public static final Integer PLUGGABLE_TASK_T_PAPER_INVOICE = 12;
    
    // invoice line types
    public static final Integer INVOICE_LINE_TYPE_ITEM_RECURRING = 1;
    public static final Integer INVOICE_LINE_TYPE_TAX = 2;
    public static final Integer INVOICE_LINE_TYPE_DUE_INVOICE = 3;
    public static final Integer INVOICE_LINE_TYPE_PENALTY = 4;
    public static final Integer INVOICE_LINE_TYPE_SUB_ACCOUNT = 5;
    public static final Integer INVOICE_LINE_TYPE_ITEM_ONETIME = 6;

    // languages - when the project is a big company, we can do this right ! :p
    public static final Integer LANGUAGE_ENGLISH_ID = 1;
    public static final String LANGUAGE_ENGLISH_STR = "English";
    public static final Integer LANGUAGE_SPANISH_ID = 2;
    public static final String LANGUAGE_SPANISH_STR = "Spanish";    

    public static final Integer ORDER_PROCESS_ORIGIN_PROCESS = 1;
    public static final Integer ORDER_PROCESS_ORIGIN_MANUAL = 2;

    //Notification Preference Types
    public static final Integer PREFERENCE_TYPE_SELF_DELIVER_PAPER_INVOICES = 13;
    public static final Integer PREFERENCE_TYPE_INCLUDE_CUSTOMER_NOTES = 14;
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP = 15;
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP2 = 16;
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP3 = 17;
    public static final Integer PREFERENCE_TYPE_USE_INVOICE_REMINDERS = 21;
    public static final Integer PREFERENCE_TYPE_NO_OF_DAYS_INVOICE_GEN_1_REMINDER = 22;
    public static final Integer PREFERENCE_TYPE_NO_OF_DAYS_NEXT_REMINDER = 23;
    ...
    // contact type
    public static final Integer ENTITY_CONTACT_TYPE = 1;

    //Jbilling Table Ids
    public static final Integer ENTITY_TABLE_ID = 5;
 ...
 //
    ...
    public static final Integer SEMI_MONTHLY_END_OF_MONTH= 15;
